    ...
    <div class="content">     
        <div class="content_design">a</div>
            <div class="conten_text">
                <h3>New Ticket</h3>
                <a href="http://localhost/psau4/admin/tickets/ticket-view.php"><button class="return-ticket" style="width:85px;">Back</button></a>
            </div>
            <hr class="hr_content">
                ...
                <form action="save_ticket.php" method="post" class="ticketing" enctype="multipart/form-data">
                    ...
                    <div class="createticket2">
                        ...
                        <select class="form-select" aria-label="Default select example" name="category"  style="margin-top:16px;">
                            <option value="College of Engineering and Computer Studies (COECS)">College of Engineering and Computer Studies (COECS)</option>
                            <option value="College of Agriculture Systems and Technology (CASTECH)">College of Agriculture Systems and Technology (CASTECH)</option>
                            <option value="College of Education (COED)">College of Education (COED)</option>
                            <option value="College of Hospitality, Entrepreneurship, and Food Sciences (CHEFS)">College of Hospitality, Entrepreneurship, and Food Sciences (CHEFS)</option>
                            <option value="College of Arts and Sciences (CAS)">College of Arts and Sciences (CAS)</option>
                            <option value="College of Veterinary Medicine (CVM)">College of Veterinary Medicine (CVM)</option>
                        </select>
