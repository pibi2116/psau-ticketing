...
<body style="background-color:#DA9235;">
    <!-- Navigation Bar -->
    <div class="navbar">
        <div class="home-nav">
            <p>PSAU</p>
    ...
    <div class="dashboard-content"style="margin-top: 65px; margin-left: 17%; margin-right: 20px; ;">
        <div class="page-heading" >
            <h3>Dashboard</h3>
            <a href="generate-report.php"><button><i class="fa-solid fa-download"></i> Generate Report</button></a>
        </div>

        <div class="grid-container">
            <?php 
            $q = "SELECT COUNT(*) AS total_tickets FROM tickets WHERE status IN ('open', 'in_progress')";
            $r = $conn->query($q);
            $row = $r->fetch_assoc();
            ?>
            <div class="grid1">
                <div class="grid-content">
                    <div class="grid-body">
                        <div class="grid-flexrow">
                            <div class="grid-flexcolumn">
                                <div class="gridtitle">Pending Tickets</div>
                                <div class="gridvalue"><?php echo $row['total_tickets'];?></div>
                            </div>
                            <div class="fav">
            ...
            <div class="grid2">
                <div class="grid-content">
                    <div class="grid-body">
                        <div class="grid-flexrow">
                            <div class="grid-flexcolumn">
                                <div class="gridtitle">Total Customers</div>
                                <div class="gridvalue"><?php echo $row['total_customers'];?></div>
                            </div>
                            <div class="fav">
            ...
            <?php 
            $q = "SELECT COUNT(*) AS total_agents FROM users where role='staff'";
            $r = $conn->query($q);
            $row = $r->fetch_assoc();
            ?>
            <div class="grid3">
                <div class="grid-content">
                    <div class="grid-body">
                        <div class="grid-flexrow">
                            <div class="grid-flexcolumn">
                                <div class="gridtitle">Total Agents</div>
                                <div class="gridvalue"><?php echo $row['total_agents'];?></div>
                            </div>
                            <div class="fav">
            ...
            <?php 
            $q = "SELECT COUNT(*) AS resolved_tickets FROM tickets where status='Resolved'";
            $r = $conn->query($q);
            $row = $r->fetch_assoc();
            ?>
            <div class="grid4">
                <div class="grid-content">
                    <div class="grid-body">
                        <div class="grid-flexrow">
                            <div class="grid-flexcolumn">
                                <div class="gridtitle">Resolved Tickets</div>
                                <div class="gridvalue"><?php echo $row['resolved_tickets'];?></div>
                            </div>
                            <div class="fav">
