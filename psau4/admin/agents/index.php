...
<div class="content_design">a</div>
    <div class="conten_text">
        ...
        <a href="create-agent.php"><button ><i class="bi bi-plus"></i>Create New</button></a>
    </div>
    <hr class="hr_content">
        ...
        <div class="table-container">
            <table id="myTable" class="display" style="width:100%">
                ...
                <tbody>
                    <?php
                    $query = "select * from users where role='staff'ORDER BY department ASC";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <td>
                        <a href='open-agent.php?id=" . $row['id'] . "'><button>OPEN</button></a>
                        </td>";
