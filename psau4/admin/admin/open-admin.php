   ...
   <?php 
    ...
    <div class="content" style="min-height: 650px; height:auto;">
        ...
        <div class="conten_text">
            ...
            <a href="javascript:void(0);" onclick="delete_rec(<?php echo $row['id']; ?>);"><button>Delete Admin</button></a>
...
<script>
    function delete_rec(id){
        ...
        if(conf==true) location.replace('delete-admin.php?id='+id);
    }
</script>
</script>
<script
