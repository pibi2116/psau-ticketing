...
if (isset($_POST['submit'])) {
    ...
    if ($password != $confirm_password) {
        echo "<script>alert('Passwords do not match.'); window.location.href = 'http://localhost/psau4/admin/customer/create-customer.php';</script>";
        ...
        if ($stmt->execute()) {
            // Prompt user
            echo "<script>alert('Account created successfully.'); window.location.href = 'http://localhost/psau4/admin/customer/index.php';</script>";
